...
6.  **إضافة البيانات التمهيدية والفهارس (Seeding & Indexing):**
    لتسهيل التجربة، تم تجهيز النظام بملفات CSV صغيرة كقوالب تجريبية جاهزة (وهمية) في مجلد `data_templates`. يمكنك تشغيل السكربت التالي لملء النظام بهذه العينات وتشغيله فوراً:
    ```bash
    python seed_db.py
    python add_indexes.py
    ```
    *(إذا كنت تملك بيانات أخرى، يمكنك إضافتها في تلك القوالب، أو تعيين مسارك الخاص عبر المتغير `CSV_DIR`)*
