...
5.  **تشغيل الخادم:**
    بمجرد تشغيل الخادم لأول مرة، سيقوم النظام بالاتصال بقاعدة البيانات وإنشاء كافة الجداول المطلوبة تلقائياً:
    ```bash
    uvicorn app.main:app --reload
    ```

6.  **إضافة بيانات المسؤول الأولية (Admin):**
    نظراً لعدم وجود بيانات مسبقة (Pre-existing Data)، سيتوجب عليك الدخول إلى قاعدة البيانات وإدخال بيانات مستخدم كـ "مسؤول" (Admin) يدوياً أولاً. بعد ذلك ستتمكن من تسجيل الدخول من الواجهة وإدارة النظام.
